(function ($) {
    ...
    $(document).ready(function() {
        ...
        $('.CheckProductType').on('click',function (){
            let name = '';
            $('.CheckProductType').each(function (){
                if($(this).is(":checked")){
                    name=$(this).val();
                    if(checkProductType.includes(name)){
                        return;
                    }else{
                        checkProductType.push(name)
                    }
                }else{
                    name=$(this).val();
                    checkProductType=checkProductType.filter(item =>item  !== name)
                }
            });
            $.ajax({
                url: $('#checkProductTypeFilter').data("url"),
                method: "get",
                data: {
        ...
        $('.CheckManufacturer').on('click',function (){
            let name = '';
            $('.CheckManufacturer').each(function (){
                if($(this).is(":checked")){
                    name=$(this).val();
                    if(checkManufacturer.includes(name)){
                        return;
                    }else{
                        checkManufacturer.push(name)
                    }
                }else{
                    name=$(this).val();
                    checkManufacturer=checkManufacturer.filter(item =>item  !== name)
                }
            });
            $.ajax({
                url: $('#checkManufacturerFilter').data("url"),
                method: "get",
                data: {
