                                ...
                                <tr class="cart-page-item">
                                    ...
                                    <td>
                                        <div class="product-price text-center">
                                            @if(currencyConverter($item->discount_percent) > 0)
                                                <h4 class="regular-price">{{currencySymbol()[currency()]}}{{currencyConverter($item->weight)}}</h4>
                                            @endif

                                            <h3 class="price">{{currencySymbol()[currency()]}}<span class="mainPrice">{{currencyConverter($item->price)}}</span> </h3>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h1 class="cart-table-item-total SubTotalAmount">{{currencySymbol()[currency()]}}{{currencyConverter($item->subtotal)}}</h1>
                                    </td>
                                    <td><button class="delet-btn deleteItem" title="{{__('Delete Item')}}" data-id="{{$item->rowId}}"><img src="{{asset('frontend/assets/images/close.svg')}}" alt="close" /></button></td>
                                </tr>
                                @endforeach
                                </div>
                            </tbody>
                    ...
                    <div class="cart-page-bottom-box cart-page-sub-total-box">
                        ...
                        <div class="sub-total-inner-box d-flex justify-content-between align-items-center">
                            <h2 class="bottom-box-title m-0">{{__('Subtotal:')}}</h2>
                                 <h2 class="bottom-box-title m-0">{{currencySymbol()[currency()]}}{{currencyConverter(subtotal())}}</h2>
                        </div>
                        ...
                        <div class="sub-total-inner-box d-flex justify-content-between align-items-center">
                            ...
                            <h2 class="bottom-box-title m-0">{{currencySymbol()[currency()]}}{{currencyConverter(Session::get('CouponAmount'))}}</h2>
                        </div>
                        @endif
                        ...
                        <div class="sub-total-inner-box d-flex justify-content-between align-items-center">
                            <h2 class="bottom-box-title m-0">{{__('Total')}}</h2>
                                ...
                                @endphp
                            <h2 class="bottom-box-title cart-page-final-total m-0">{{currencySymbol()[currency()]}}{{currencyConverter($all_total) }}</h2>
                        </div>

                        <div class="form-button text-center">
                            <a href="{{route('checkout')}}" class="form-btn proceed-to-checkout-btn">{{__('Proceed To Checkout')}}</a>
                        </div>
                    </div>
                </div>
                <!-- Cart page bottom box -->
