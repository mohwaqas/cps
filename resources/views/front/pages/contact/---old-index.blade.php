                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info border-0 text-center">
                                    ...
                                    <p class="contact-info-content">{{__('Send us a text & an ambassador will respond (800)-218-1798')}}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info text-center">
                                    ...
                                    <p class="contact-info-content">{{__('2626 Aero Drive, Grand Prairie, TX Dallas USA')}} </p>
                                </div>
                            </div>
