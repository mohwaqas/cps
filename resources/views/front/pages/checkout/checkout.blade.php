                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check card-check">
                                                    ...
                                                    <label class="form-check-label" for="COD">Bank wire</label>
                                                    <div class="input-icon">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-list">
                                ...
                                <li>{{__('VAT/Tax ')}} (8.25%) <span id="tax-show-curr">{{currencySymbol()[currency()]}}{{currencyConverter(tax_amount(\Cart::subtotal()))}}</span></li>
                            ...
                            <div class="total-amount">
                                <h3>{{__('Total Cost')}} <span class="float-right" id="total-cost-curr">{{currencySymbol()[currency()]}}{{currencyConverter(round(\Cart::subtotal() + allsetting()['shipping_charge'] + tax_amount(\Cart::subtotal())) - Session::get('CouponAmount'),2)}}</span></h3>
                            </div>
                            <p><span style="font-weight: bold;">Note: </span>Shipping cost will be provided accordingly on given invoice 
</p>
                        </div>
                    </div>
                </div>
