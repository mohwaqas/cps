                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('brand.product_left', $category_m->en_BrandSlug)}}" class="view-btn list-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter" >
                                            ...
                                            @foreach(Brnad() as $item)
                                                <option  value="{{route('brand.product_left', $item->en_BrandSlug)}}">{{ langConverter($item->en_BrandName, $item->fr_BrandName)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
