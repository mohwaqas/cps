...
@section('title', isset($title) ? $title : 'Home11')
                        ...
                        <div class="single-widget search-widget">
                            ...
                            <form>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="searchwidget" name="searchwidget" placeholder="{{__('Solar Panel Store')}}" />
                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                  ...
                                  <!--   <div class="list-grid-view">
                                        <a href="{{route('product.list.left.sidebar')}}" class="view-btn list-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('all.product')}}" class="view-btn grid-view active">
                                            <img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" />
                                        </a>
                                    </div> -->
                                </div>
                            </div>
                            ...
                            @foreach($products as $product)
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-grid-product">
                                        ...
                                        @if($product->is_called==1)
                                            <span style="width:134px; font-weight:bold; color:red;" onclick="changeText()"> Call for Price</span>  
                                        @else  
...
<style>
     .single-grid-product .product-info .product-name{height: 35px!important;}
...
<script>
 function changeText() {
     document.getElementsByTagName("span")[0].innerHTML = "(800)-218-1798";
 }
</script>
