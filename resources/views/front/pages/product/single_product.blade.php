                    ...
                    <div class="col-lg-4">
                        <div class="product-single-right">
                            <div class="product-info">
                                ...
                                <h1 class="product-name">{{langConverter($products->en_Product_Name,$products->fr_Product_Name)}}</h1>
...
<!-- 
                                <table class="table">
                                    ...
                                    <tr> 
                                        <td>Texas</td>
                                        <td>{{@$products->location[0]['location1']}}</td>
                                        <td>
                                             @if(@$products->location[0]['location_next1']=='')
                                                <span style="font-style: italic;font-size: 11px;">Coming Soon</span>
                                            @else    
                                                {{@$products->location[0]['location_next1']}} <span style="font-style: italic;font-size: 12px;">{{@$products->location[0]['location_date1']}}</span>
                                            @endif
                                        </td>
                                    ...
                                    <tr>
                                        <td>Maryland</td>
                                        <td>{{@$products->location[0]['location2']}}</td>
                                        <td>
                                            @if(@$products->location[0]['location_next2']=='')
                                                <span style="font-style: italic;font-size: 11px;">>Coming Soon</span>
                                            @else
                                                {{@$products->location[0]['location_next2']}} <span style="font-style: italic;font-size: 12px;">{{@$products->location[0]['location_date2']}}</span>
                                            @endif    
                                            </td> 
                                    </tr> 
                                </table> -->
                                 ...
                                 {!!  clean(langConverter($products->en_AdditionalInformation,$products->fr_AdditionalInformation)) !!}    </p>
...
<style>
    ...
    .note-text p{margin: 0px!important;}
    .product-single-area .product-single-details .product-info .product-name{line-height: 4rem!important;}
