                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                   ...
                                   <!--  <div class="list-grid-view">
                                        <a href="{{route('category.product_left', $category_m->id)}}" class="view-btn list-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
