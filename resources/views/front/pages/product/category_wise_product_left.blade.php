                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('category.product_left', $category_m->en_Category_Slug)}}" class="view-btn list-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('brand.product', $category_m->en_Category_Slug)}}" class="view-btn grid-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter" >
                                            ...
                                            @foreach(Category() as $item)
                                                <option  value="{{route('category.product_left', $item->en_Category_Slug)}}">{{ langConverter($item->en_Category_Name, $item->fr_Category_Name)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
                            ...
                            @forelse($products as $product)
                                <div class="single-list-product">
                                    <div class="product-left">
                                        @if($user)
                                            <a href="{{route('single.product',$product->en_Product_Slug)}}"><img class="product-thumbnal" src="{{asset(ProductImage().$product->Primary_Image)}}" alt="product" />
                                            </a>
                                        @else
