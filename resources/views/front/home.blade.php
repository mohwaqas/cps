...
<div id="simpleModal" class="modal hidden-xs hidden-sm hidden-md  " tabindex="-1" role="dialog" style="top:20%; left:-2%">

    <div class="modal-dialog" role="document">

        <div class="modal-content" style="width: 124%;">
              <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close btn-close btn-close-white" style="position: absolute;
    color: #fff; padding-left:94%;     opacity: 1.4;">close</button> 




           <a href="https://cleanpowerstore.com/user/sign-up">
            <img class="ppopup" src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/05/popupR03-06.jpg" usemap="#image-map">
           </a>
    ...
    <div id="myCarousel" class="carousel slide hidden-sm hidden-xs" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item @if($key==1) active @endif" >
                <a href="{{route('all.product')}}"> <div class="signle-slide" style="width: 100%;
                    height: 480px; /*calc(100vh - (2em + 18px)); */
                    background-image: url('{{asset(SliderImage().$slider->Background_Image)}}');
...
<div class="pt-offset-10 container-indent"><br><br>
    <div class="pt-block-title" align="center">
    <h4 class="pt-title wow fadeInUp animated" data-wow-delay="1s">Our Unique Products</h4></div><br>
    <div class="container-fluid">
        <div class="pt-layout-promo-box ">
            <div class="row">
                <div class="col-sm-6 col-sm-6 col-md-3">
                    <a href="https://cleanpowerstore.com/battery" class="pt-promo-box wow zoomIn animated" data-wow-delay="1s">
                        <div class="image-box">
                        ...
                        <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                            <div class="pt-description-wrapper">
                                <div class="pt-color-white pt-title-large" style="color:#fff"><span>Batteries</span> </div>
                            </div>
                        </div>
                    </a>
                    <a href="https://cleanpowerstore.com/solar-accessories" class="pt-promo-box wow zoomIn animated" data-wow-delay="1s">
                        <div class="image-box">
                            <img src="{{ URL::to('/') }}/uploaded_files/general_settings/assess.png" alt="" class="loading" data-was-processed="true">
                        </div>
                        <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                            <div class="pt-description-wrapper">
                                <div class="pt-color-white pt-title-large" style="color:#fff" > <span>Accessories</span></div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-md-3">
                    <a href="https://cleanpowerstore.com/panel" class="pt-promo-box wow zoomIn animated" data-wow-delay="2s">
                        <div class="image-box">
                            <img src="{{ URL::to('/') }}/uploaded_files/general_settings/s.png" alt="" class="loading" data-was-processed="true">
                        </div>
                        <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                            <div class="pt-description-wrapper">
                                <div class="pt-color-white pt-title-large " style="color:#fff"> <span>Solar Panel</span></div>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="https://cleanpowerstore.com/inverter" class="pt-promo-box wow zoomIn animated" data-wow-delay="2s">
                                <div class="image-box">
                                    <img src="{{ URL::to('/') }}/uploaded_files/general_settings/Inverter.png" alt="" class="loading" data-was-processed="true">
                                </div>
                                <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                                    <div class="pt-description-wrapper">
                                        <div class="pt-color-white pt-title-large" style="color:#fff"><span>Inverter</span> </div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-6">
                            <a href="https://cleanpowerstore.com/solar-kits" class="pt-promo-box wow zoomIn animated" data-wow-delay="3s">
                                <div class="image-box">
                                    <img src="{{ URL::to('/') }}/uploaded_files/general_settings/solar-kit.png" alt="" class="loading" data-was-processed="true">
                                </div>
                                <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                                    <div class="pt-description-wrapper">
                                        <div class="pt-color-white pt-title-large" style="color:#fff"> <span>Solar Kit</span></div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-12">
                            <a href="https://cleanpowerstore.com/racking-system" class="pt-promo-box wow zoomIn animated" data-wow-delay="3s">
                                <div class="image-box">
                                    <img src="{{ URL::to('/') }}/uploaded_files/general_settings/Rac.png" alt="" class="loading" data-was-processed="true">
                                </div>
                                <div class="pt-description pr-promo-type1 pt-point-v-t pt-point-h-l">
                                    <div class="pt-description-wrapper">
                                        <div class="pt-color-white pt-title-large" style="color:#fff"><span>Racking System</span> </div>
                                    </div>
                                </div>
                            </a>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <a class="single-categorie" href="{{route('category.product',$item->en_Category_Slug)}}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="pt-block-title">
                        <h4 class="pt-title wow fadeInDown animated" data-wow-delay="2s">Our Best Products</h4>
                    </div><br>
                </div>
        ...
        <div class="row" style="    margin-top: -36px;">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product">
                    <div class="product-top wow fadeInUp animated" data-wow-delay="1s">
                    ...
                    <div class="product-info text-center animate__animated animate__zoomIn animate__delay-1s">
                        
                        <input type="hidden" name="quantity" value="1" id="product_quantity">
                        <h3 class="product-name">
                        <div style="height: 40px;">
                            <a class="product-link" style="    font-size: 20px;" href="{{route('single.product',$product->en_Product_Slug)}}">{{substr(langConverter($product->en_Product_Name,$product->fr_Product_Name),0,26)}}</a>
                        </div>
            ...
            @endforeach
            <div class="col-md-12 align-self-end text-md-end" align="center">
                <a href="{{route('all.product')}}" class="btn btn-praimry custom-btn-header"  style="font-size: 25px;">{{__('See All')}}</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="section-header-area">
            <div class="row">
                <div class="col-md-12"> 
                    <br><br><br>
                    <div class="pt-block-title">
                        <h4 class="pt-title wow fadeInDown animated" data-wow-delay="2s">Panels Products</h4>
                    </div><br>
                </div>
         ...
         <?php $count=0; ?>
        <div class="row" style="    margin-top: -36px;">
            @foreach($panel_category_products as $product) 
        ...
        <div class="section-header-area">
            <div class="row">
                <div class="col-md-12"> 
                    <br><br><br>
                    <div class="pt-block-title">
                        <h4 class="pt-title wow fadeInDown animated" data-wow-delay="2s">Solar Kits</h4>
                    </div><br>
                </div>
         ...
         <?php $count=0; ?>
        <div class="row" style="    margin-top: -36px;">
            @foreach($solar_kits_products as $product) 
...
<div class="container-indent ">
    <div class="container" >
        <div class="pt-block-title">
            <h4 class="pt-title pt-promo-box wow bounceInLeft animated" data-wow-delay="0s">Latest Happening In Renewable Energy Sector</h4>
        </div>
        <div class="pt-content-post row arrow-location-center-02 wow bounceInRight animated" data-wow-delay="1s">
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="pt-post animate__slideInLeft animate__fadeIn animate__delay-1s">
                    <div class="pt-post-img">
                        <a href="https://cleanpowerstore.com/blog/dc-fast-charging-for-electric-vehicles-all-you-need-to-know/">
                            <img src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/10/infographics-19-04-2048x1171.webp" style="height: 250px;" class="lazyload loaded" data-src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/10/infographics-19-04-2048x1171.webp" alt="DC Fast Charging for Electric " data-was-processed="true">
                        </a>
                    </div>
                    <div class="pt-post-content">
                        <h2 class="pt-title"><a href="https://cleanpowerstore.com/blog/dc-fast-charging-for-electric-vehicles-all-you-need-to-know/">DC Fast Charging for Electric Vehicles: All You Need to Know</a></h2>
                        <div class="pt-meta">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="pt-post animate__slideInLeft animate__fadeIn animate__delay-1s wow bounceInRight animated" data-wow-delay="2s">
                    <a href="https://cleanpowerstore.com/blog/a-guide-to-solar-panel-maintenance-and-repair-2023/">
                        <img src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/09/infographics-17-02-2048x1171.webp" style="height: 250px;" class="lazyload loaded" data-src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/09/infographics-17-02-2048x1171.webp" alt="A Guide to Solar Panel Maintenance and Repair (2023)" data-was-processed="true">
                    </a>
                    <div class="pt-post-content">
                        <h2 class="pt-title"><a href="https://cleanpowerstore.com/blog/a-guide-to-solar-panel-maintenance-and-repair-2023/">A Guide to Solar Panel Maintenance and Repair (2023)</a></h2>
                        <div class="pt-meta">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="pt-post animate__slideInLeft animate__fadeIn animate__delay-1s wow bounceInRight animated" data-wow-delay="3s">
                    <div class="pt-post-img">
                        <a href="https://cleanpowerstore.com/blog/solar-farms-a-comprehensive-guide-for-investors/">
                            <img src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/10/infographics-18-01-2048x1171.webp" style="height: 250px;" class="lazyload loaded" data-src="https://cleanpowerstore.com/blog/wp-content/uploads/2023/10/infographics-18-01-2048x1171.webp" alt="A Comprehensive Guide for Investors" data-was-processed="true">
                        </a>
                    </div>
                    <div class="pt-post-content">
                        <h2 class="pt-title"><a href="https://cleanpowerstore.com/blog/solar-farms-a-comprehensive-guide-for-investors/">Solar Farms: A Comprehensive Guide for Investors</a></h2>
                        <div class="pt-meta">
...
<!-- <div class="section">
    <div class="container mt-5 mb-5">
        <div class="pt-block-title">
            <h4 class="pt-title  wow fadeInUpBig animated" data-wow-delay="1s">Our Clients Endorsements </h4>
        </div>
        
        <div class="row g-2">
            <div class="col-md-4  wow fadeInRight animated" data-wow-delay="1s">
                <div class="card p-3 text-center px-4" style="    height: 295px;">
                    <div class="user-image">
                        <img src="{{ URL::to('/') }}/uploaded_files/general_settings/c1.png" class="rounded-circle animate__animated animate__flipInY animate__delay-1s" width="80"
                        >
                    ...
                    <div class="user-content">
                        ...
                        <h5 class="mb-0">William Den</h5>
                        <span>Marketing Exective</span>
                        <p>I thought of considering this service on the recommendation of my friend. Not only do they helped me in the installation of my product. But also helped me to grab more of the products after countless aspects of quality. So, thanks to Cleanpower store for their splendid quality.  </p>
            ...
            <div class="col-md-4  wow fadeInRight animated" data-wow-delay="2s">
                ...
                <div class="card p-3 text-center px-4" style="    height: 295px;">
                    ...
                    <div class="user-image">
                        ...
                        <img src="{{ URL::to('/') }}/uploaded_files/general_settings/c2.png" class="rounded-circle animate__animated animate__flipInY animate__delay-1s" width="80" />
                        
                    </div>
                    
                    <div class="user-content">
                        
                        <h5 class="mb-0">Benjamin Collins</h5>
                        <span>Freelancer</span>
                        <p>After taking interest by perks of solar energy again and again. I just thought that why should not I grab products of solar. Therefore, I happened to come across this innovative store. It has wide range of solar products. Likewise, it helped me alot to grab valuable products for my solar requirements.</p>
            ...
            <div class="col-md-4  wow fadeInRight animated"  data-wow-delay="3s">
                <div class="card p-3 text-center px-4" style="    height: 295px;">
                    <div class="user-image">
                        <img src="{{ URL::to('/') }}/uploaded_files/general_settings/c3.png" class="rounded-circle animate__animated animate__flipInY animate__delay-1s" width="80">
                        
                    </div>
                    
                    <div class="user-content">
                        
                        <h5 class="mb-0">David Jhonson</h5>
                        <span>Account Manager</span>
                        <p>My quest of searching solar products was resolved by cleanpower store.I was not only able to buy quality based products but the staff itself helped me to resolve my queries. From my side this store is highly recommended! </p>
...
<!--js -->
<link rel="stylesheet" href="{{asset('frontend/assets/js/front/skrollr.js')}}">
