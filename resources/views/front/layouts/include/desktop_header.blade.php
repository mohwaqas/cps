    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-middle-wrap">
                <div class="">
                    <div class="row">
                        <div class="md-6"><a class="brand-logo" href="{{route('front')}}"><img style="width:390px" class="brand-image" src="{{asset(GeneralSettingsImage().GeneralSettings()->Logo)}}" alt="logo" /></a>
                    </div>
                  </div>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 200px;"><li class="mega-menu-item">
                                            <ul class="menu-items" style="margin-top:-40px">
