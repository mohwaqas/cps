            ...
            <form>
                <div class="search-wrap">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="mobilesearch" name="search" placeholder="{{__('Search Products...')}}" />
        ...
        <nav class="main-menu">
            <ul class="menu-list">
                ...
                <li class="menu-item">
                    ...
                    <ul class="sub-menu">
                        @foreach(Category() as $item)
                            <li class="sub-menu-item"><a class="sub-menu-link" href="{{route('category.product',$item->id)}}">{{langConverter($item->en_Category_Name,$item->fr_Category_Name)}}</a></li>
                        @endforeach
                    </ul>
                </li>
                @foreach($all_menus as $menu)
                    ...
                    @endif
                @endforeach
                <li class="menu-item"><a class="menu-link" href="{{route('about.us')}}">{{ staticMenuName('about-us') }}</a></li>
                <li class="menu-item"><a class="menu-link" href="{{route('blog')}}">{{ staticMenuName('blog') }}</a></li>
                <li class="menu-item"><a class="menu-link" href="{{route('contact.us')}}">{{ staticMenuName('contact') }}</a></li>
        ...
        <div class="menu-bottom">
            <div class="switcher-lang-currency">
                ...
                <div class="lang-switcher">
                    ...
                    <ul class="lang-list">
                        @if(app()->getLocale() == 'en')
                            <li class="single-lang"><span class="flag"><img src="{{asset(IMG_LANGUAGE.getLanguage('fr')->thumb)}}" alt="united-states" /></span><a class="lang-text" href="{{route('locale.switch','fr')}}">{{ getLanguage('fr')->name }}</a></li>
                        @elseif(app()->getLocale() == 'fr')
