                            ...
                            <div class="single-widget">
                                ...
                                <ul class="widget-menu show">
                                  <!--   @foreach(Category() as $item)
                                    <li class="menu-item"><a class="menu-link" href="{{route('category.product',$item->id)}}">{{langConverter($item->en_Category_Name,$item->fr_Category_Name)}}</a></li>
                                    @endforeach -->                              
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/battery">Battery</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/inverter">Inverter</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/panel">Panel</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/solar-kits">Solar Kits</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/solar-accessories">Solar Accessories</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/racking-system">Racking System</a></li>  
                                </ul>
                            ...
                            <div class="single-widget"> 
                                ...
                                <ul class="widget-menu">
                                 ...
                                 <!--    @foreach(Brnad6() as $item)
                                    ...
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/franklin-wh">Franklin WH</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/hoymiles">Hoymiles</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/recom">Recom</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/convalt">Convalt</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/solax">Solax</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/rec-solar">REC Solar</a></li>
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="single-widget">
                                ...
                                @endif    
                                    ...
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/longi-solar">Longi solar</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/mission-solar">Mission Solar</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/qcells">Qcells</a></li>
                                    <li class="menu-item"><a class="menu-link" href="https://cleanpowerstore.com/brand/chiko">Chiko</a></li>
...
<style>
    .js-cookie-consent {display: none;} .cookie-consent{display: none!important;}
    .footer-area{
...
.footer-area .footer-widget-area .widget-menu .menu-item .menu-link{color:#5b5959!important;}
.address-text{color:#5b5959!important;}
.contact{color:#5b5959!important;}
.address p{margin:0px!important}
