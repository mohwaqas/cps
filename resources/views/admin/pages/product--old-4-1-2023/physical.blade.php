                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="display: none;">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('ShippingReturn')}}</label>
                                                <textarea name="fr_shippingreturn" id="fr_shippingreturn" class="form-control summernote">Product</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('AdditionalInformation')}}</label>
                                                <textarea name="fr_additionalinformation" id="fr_additionalinformation" class="form-control summernote">Product</textarea>
                                            </div>
