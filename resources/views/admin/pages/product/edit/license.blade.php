                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        ...
                                                        <input type="text" class="form-control" name="license_name" id="license-name" value="{{$product->license_name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="digital-file">{{ __('License Key')}}</label>
                                                        <input type="text" class="form-control" name="license_key" id="license-key" value="{{$product->license_key}}">
                                                    </div>
                                                </div>
                                            </div>
