                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Affiliate Link')}}</label>
                                                <input type="text" class="form-control" id="affiliate-link" name="affiliate_link" value="{{$product->affiliate_link}}">
                                            </div>
                                            <div class="input__group mb-25">
