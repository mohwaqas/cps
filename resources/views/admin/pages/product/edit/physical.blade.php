                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="row">
                                                    <div><input  @if($product->showing_home==1) checked @endif  type="checkbox" name="showing_home" value="1" />  Show Home Page</div>
                                                </div>    
                                         ...
                                         <!--      <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" class="form-control" value="{{$product->Discount_Price}}" id="discount_price" name="discount_price" readonly>
                                                 ...
                                                 <div class="input__group mb-25"><br>
                                                <label for="exampleInputEmail1">{{ __('Retail Price')}}</label>
                                                <input type="text" class="form-control" id="price" name="price" value="{{$product->Price}}"> 
                                                <table>
                                                    <tr>
                                                        <td style="width:20px;"><input type="checkbox" value="1" name="is_called" @if($product->is_called==1) checked @endif /></td>
                                                        <td>Call for Show Price</td>
                                                    </tr>
                                                </table>
                                            ...
                                            <div class="input__group mb-25"  >
                                                ...
                                                <textarea name="en_additionalinformation_old" id="en_additionalinformation_old" class="form-control summernote">
                                                    {!! $product->en_AdditionalInformation !!}
                                                </textarea>
                                            </div> 
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">Spec Sheet (PDF)</label>
                                                 ...
                                                 @if($product->Spec_Sheet)
                                                   ...
                                                   <table><tr>
                                                       <td><input type="checkbox" name="spec_sheet_del_1" value="1"></td>
                                                       <td>Remove</td>
                                                   </tr></table>
                                                 ...
                                                 @if($product->Spec_Sheet2)
                                                  <a target="_blank"  href="{{url('uploaded_files/spec_sheets/')}}/{{$product->Spec_Sheet2}}">Download </a>
                                                   <input type="hidden" value="{{$product->Spec_Sheet2}}" name="s_sheet2" />
                                                     ...
                                                     <table><tr>
                                                       <td><input type="checkbox" name="spec_sheet_del_2" value="1"></td>
                                                       <td>Remove</td>
                                                   </tr></table>
                                                 @endif
                                            </div>
                                                 ...
                                                 <input type="file" name="spec_sheet3" value="" />
                                                  ...
                                                  <a target="_blank"  href="{{url('uploaded_files/spec_sheets/')}}/{{$product->Spec_Sheet3}}">Download </a>
                                                   <input type="hidden" value="{{$product->Spec_Sheet3}}" name="s_sheet3" />
                                                     ...
                                                     <table><tr>
                                                       <td><input type="checkbox" name="spec_sheet_del_3" value="1"></td>
                                                       <td>Remove</td>
                                                   </tr></table>
                                                 @endif
                                            </div>
                                                 ...
                                                 <input type="file" name="spec_sheet4" value="" />
                                                  ...
                                                  <a target="_blank"  href="{{url('uploaded_files/spec_sheets/')}}/{{$product->Spec_Sheet4}}">Download </a>
                                                   <input type="hidden" value="{{$product->Spec_Sheet4}}" name="s_sheet4" />
                                                     ...
                                                     <table><tr>
                                                       <td><input type="checkbox" name="spec_sheet_del_4" value="1"></td>
                                                       <td>Remove</td>
                                                   </tr></table>
                                                 @endif
                                            </div>
