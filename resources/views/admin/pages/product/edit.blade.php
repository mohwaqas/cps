                        ...
                        <div class="tab-content slider-page-form" id="pills-tabContent">
                            ...
                            <div class="card-body ">
                                <form enctype="multipart/form-data" method="POST" action="{{route('admin.product.update')}}">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="select2Multiple">{{ __('Product Size')}}</label>
                                             <input type="text" class="form-control" id="size_new" value="{{$item->Size_New}}" name="size_new">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="input__group mb-25">
                                                ...
                                                <div class="row">
                                                    <div><input type="checkbox" value="1" name="is_called" @if($product->is_called==1) checked @endif /></div><div>Call to Show Price</div>
                                                </div>    
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" style="display: inline;">
