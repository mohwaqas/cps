    ...
    @foreach ($orders as $order)
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center table-flush">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>{{__('Tax')}} (8.25): </td>
                                                <td><?php echo (($order->Grand_Total * 8.25) / 100); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                   $tax = (($order->Grand_Total * 8.25) / 100) + $order->Grand_Total;
                                                   ?>
                                                <td>{{$tax}}</td>
                                            </tr>
                                            </tbody>
        ...
        <div class="modal fade bd-example-modal-sm" id="changeModal{{$order->id}}" tabindex="-1" role="dialog" aria-labelledby="changeeModalTitle{{$order->id}}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-success">
                        <h5 class="modal-title text-white" id="viewModalLongTitle">{{__('Change Status & Add Discount')}}</h5>
                        <button type="button" class="close text-white" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="number" class="form-control" id="admin_discount" name="admin_discount" placeholder="Discount ($)">
                        </div>
                         <div class="input__group mb-25">
                            <label><input type="checkbox" name="chk" id="chk" /> Warehouses</label>
                              <select class="form-select" name="location" id="location">
                                    <option value="location1">N.West</option>  
                                    <option value="location2">S.West</option>
                                    <option value="location3">Central</option>
                                    <option value="location4">N.East</option>
                                    <option value="location5">S.East</option>
                              </select>
                        </div>
