...
<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @endcanany
        <li class="{{ isset($menu) && $menu == 'package' ? 'mm-active' : ''  }}">
            <a href="{{route('admin.package_list')}}">
        ...
        @endcanany
        <li class="{{ isset($menu) && $menu == 'report' ? 'mm-active' : ''  }}">
            <a class="has-arrow" href="#">
                <i class="fas fa-bar-chart"></i>
                <span>{{__('Reports')}}</span>
            </a>
            <ul>
                <li class="{{isset($submenu) && $submenu == 'order_reports' ? 'mm-active' : '' }}">
                    <a href="{{route('admin.order-reports')}}">
                        <i class="fa fa-circle"></i>
