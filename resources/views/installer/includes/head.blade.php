<head>
    ...
    <!-- Favicon included -->
    <link rel="shortcut icon" href="{{asset(IMG_FAVICON_PATH.'clean-power-store-favicon.png')}}" type="image/x-icon">

    <!-- Apple touch icon included -->
    <link rel="apple-touch-icon" href="{{asset(IMG_FAVICON_PATH.'clean-power-store-favicon.png')}}">
