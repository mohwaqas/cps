...
//session value store get and delete
    ...
    Route::get('solar-calculator', [AboutUsController::class, 'calculator'])->name('solar-calculator');
...
Route::get('installer/dashboard', [InstallerController::class, 'installerDashboard'])->name('installer.dashboard')->middleware('is_installer');
Route::get('installer/orders', [InstallerController::class, 'installerOrders'])->name('installer.orders')->middleware('is_installer');