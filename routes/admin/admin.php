...
Route::get('/product_image_remove/{id}', [ProductController::class, 'product_image_remove'])->name('product.image.delete');
...
Route::group(['prefix' => 'subscribe'],function (){
    ...
    Route::post('promote', [SubscribeController::class, 'promote'])->name('admin.subscribe.promote');
});
...
Route::group(['prefix' => 'admin','middleware' => ['auth','is_admin', 'en.locale'],'as' =>'admin.'],function(){
        ...
        Route::post('/create', [SliderController::class, 'sliderStore'])->name('slider.store')->middleware(['permission:slider-create']);
        Route::get('/edit/{id}', [SliderController::class, 'sliderEdit'])->name('slider.edit')->middleware(['permission:slider-edit']);
        Route::post('/update', [SliderController::class, 'sliderUpdate'])->name('slider.update')->middleware(['permission:slider-edit']);
        Route::get('/delete/{id}', [SliderController::class, 'sliderDelete'])->name('slider.delete')->middleware(['permission:slider-delete']);
    });
    Route::group(['prefix' => 'advertise'],function (){
        ...
        Route::post('/create', [AdvertiseController::class, 'advertiseStore'])->name('advertise.store')->middleware(['permission:advertise-create']);
        Route::get('/edit/{id}', [AdvertiseController::class, 'advertiseEdit'])->name('advertise.edit')->middleware(['permission:advertise-edit']);
        Route::post('/update', [AdvertiseController::class, 'advertiseUpdate'])->name('advertise.update')->middleware(['permission:advertise-edit']);
        Route::get('/delete/{id}', [AdvertiseController::class, 'advertiseDelete'])->name('advertise.delete')->middleware(['permission:advertise-delete']);
    });
    ...
    Route::group(['prefix' => 'contact-us'],function (){
        ...
        Route::post('send/reply', [ContactUsController::class, 'sendReply'])->name('send.reply')->middleware(['permission:crm-create']);
        Route::get('/delete/{id}', [ContactUsController::class, 'contactUsDelete'])->name('contact.us.delete')->middleware(['permission:crm-delete']);;
    });
    Route::group(['prefix' => 'general-settings'],function (){
        ...
        Route::post('/update', [GeneralSettingsController::class, 'GeneralSettingsUpdate'])->name('general.settings.update')->middleware(['permission:cms-edit']);
        Route::post('/update-settings', [GeneralSettingsController::class, 'updateSettings'])->name('general.settings.update_settings')->middleware(['permission:cms-edit']);
        Route::post('/update-social-login', [GeneralSettingsController::class, 'updateSocialLogin'])->name('general.settings.update_social_login')->middleware(['permission:cms-edit']);
        Route::post('/update-email', [GeneralSettingsController::class, 'updateEmail'])->name('general.settings.update_email')->middleware(['permission:cms-edit']);
    });
    ...
    Route::group(['prefix' => 'blog'],function (){
        ...
        Route::post('/create', [BlogController::class, 'blogStore'])->name('blog.store')->middleware(['permission:blog-create']);
        Route::get('/edit/{id}', [BlogController::class, 'blogEdit'])->name('blog.edit')->middleware(['permission:blog-edit']);
        Route::post('/update', [BlogController::class, 'blogUpdate'])->name('blog.update')->middleware(['permission:blog-edit']);
        Route::get('/delete/{id}', [BlogController::class, 'blogDelete'])->name('blog.delete')->middleware(['permission:blog-delete']);
    });
    ...
    Route::group(['prefix' => 'category'],function (){
        ...
        Route::post('/create', [CategoryController::class, 'categoryStore'])->name('category.store')->middleware(['permission:category-create']);
        Route::get('/edit/{id}', [CategoryController::class, 'categoryEdit'])->name('category.edit')->middleware(['permission:category-edit']);
        Route::post('/update', [CategoryController::class, 'categoryUpdate'])->name('category.update')->middleware(['permission:category-edit']);
        Route::get('/active/{id}', [CategoryController::class, 'categoryActive'])->name('category.active')->middleware(['permission:category-edit']);
        Route::get('/inactive/{d}', [CategoryController::class, 'categoryInactive'])->name('category.inactive')->middleware(['permission:category-edit']);
        Route::get('/delete/{id}', [CategoryController::class, 'categoryDelete'])->name('category.delete')->middleware(['permission:category-delete']);
    });
    Route::group(['prefix' => 'brand'],function (){
        ...
        Route::post('/create', [BrandController::class, 'brandStore'])->name('brand.store')->middleware(['permission:brand-create']);
        Route::get('/edit/{id}', [BrandController::class, 'brandEdit'])->name('brand.edit')->middleware(['permission:brand-edit']);
        Route::post('/update', [BrandController::class, 'brandUpdate'])->name('brand.update')->middleware(['permission:brand-edit']);
        Route::get('/active/{id}', [BrandController::class, 'brandActive'])->name('brand.active')->middleware(['permission:brand-edit']);
        Route::get('/inactive/{d}', [BrandController::class, 'brandInactive'])->name('brand.inactive')->middleware(['permission:brand-edit']);
        Route::get('/delete/{id}', [BrandController::class, 'brandDelete'])->name('brand.delete')->middleware(['permission:brand-delete']);
    });
    ...
    Route::group(['prefix' => 'image-gallery'],function (){
        ...
        Route::post('/create', [ImageGalleryController::class, 'imageGalleryStore'])->name('image.gallery.store')->middleware(['permission:cms-create']);
        Route::get('/edit/{id}', [ImageGalleryController::class, 'imageGalleryEdit'])->name('image.gallery.edit')->middleware(['permission:cms-edit']);
        Route::post('/update', [ImageGalleryController::class, 'imageGalleryUpdate'])->name('image.gallery.update')->middleware(['permission:cms-edit']);
        Route::get('/delete/{id}', [ImageGalleryController::class, 'imageGalleryDelete'])->name('image.gallery.delete')->middleware(['permission:cms-delete']);
    });
    ...
    Route::group(['prefix' => 'profile/'],function (){
        ...
        Route::post('change-password',[AdminProfileController::class,'changePassword'])->name('change_password');
    });
    ...
    Route::group(['prefix' => 'product'],function (){
        ...
        Route::post('/create', [ProductController::class, 'productStore'])->name('product.store')->middleware(['permission:product-create']);
        Route::get('/edit/{product_type}/{id}', [ProductController::class, 'productEdit'])->name('product.edit')->middleware(['permission:product-edit']);
        Route::post('/update', [ProductController::class, 'productUpdate'])->name('product.update')->middleware(['permission:product-edit']);
        Route::get('/active/{id}', [ProductController::class, 'productActive'])->name('product.active')->middleware(['permission:product-edit']);
        Route::get('/inactive/{d}', [ProductController::class, 'productInactive'])->name('product.inactive')->middleware(['permission:product-edit']);
        Route::get('/delete/{id}', [ProductController::class, 'productDelete'])->name('product.delete')->middleware(['permission:product-delete']);
        Route::get('/duplicate/{id}', [ProductController::class, 'duplicate'])->name('product.duplicate')->middleware(['permission:product-list|product-create|product-edit|product-delete']);;
    ...
    Route::group(['prefix' => 'product-color'],function (){
        ...
        Route::post('/create', [ColorController::class, 'productColorStore'])->name('product.color.store')->middleware(['permission:product-create|product-edit']);
        ...
        Route::post('/update', [ColorController::class, 'productColorUpdate'])->name('product.color.update')->middleware(['permission:product-create|product-edit']);
        Route::get('/delete/{id}', [ColorController::class, 'productColorDelete'])->name('product.color.delete')->middleware(['permission:product-create|product-edit']);
    });
    ...
    Route::group(['prefix' => 'product-size'],function (){
        ...
        Route::post('/create', [SizeController::class, 'productSizeStore'])->name('product.size.store')->middleware(['permission:product-create|product-edit']);
        ...
        Route::post('/update', [SizeController::class, 'productSizeUpdate'])->name('product.size.update')->middleware(['permission:product-create|product-edit']);
        Route::get('/delete/{id}', [SizeController::class, 'productSizeDelete'])->name('product.size.delete')->middleware(['permission:product-create|product-edit']);
    });
    ...
    Route::group(['prefix' => 'product-tag'],function (){
        ...
        Route::post('/create', [ProductTagController::class, 'productTagStore'])->name('product.tag.store')->middleware(['permission:product-create|product-edit']);
        ...
        Route::post('/update', [ProductTagController::class, 'productTagUpdate'])->name('product.tag.update')->middleware(['permission:product-create|product-edit']);
        Route::get('/delete/{id}', [ProductTagController::class, 'productTagDelete'])->name('product.tag.delete')->middleware(['permission:product-create|product-edit']);
    });
    ...
    Route::group(['prefix' => 'item-tag'],function (){
        ...
        Route::post('/create', [ItemTagController::class, 'itemTagStore'])->name('item.tag.store')->middleware(['permission:product-create|product-edit']);
        ...
        Route::post('/update', [ItemTagController::class, 'itemTagUpdate'])->name('item.tag.update')->middleware(['permission:product-create|product-edit']);
        Route::get('/delete/{id}', [ItemTagController::class, 'itemTagDelete'])->name('item.tag.delete')->middleware(['permission:product-create|product-edit']);
    });
    ...
    Route::group(['prefix' => 'customer-services'],function (){
        ...
        Route::post('/update', [CustomerServiceController::class, 'customerServiceUpdate'])->name('customer.services.update')->middleware(['permission:crm-edit']);
    });
    ...
    Route::group(['prefix' => 'company-story'],function (){
        ...
        Route::post('/create', [CompanyStroyController::class, 'companyStoryStore'])->name('company.story.store')->middleware(['permission:cms-create']);
        Route::get('/edit/{id}', [CompanyStroyController::class, 'companyStoryEdit'])->name('company.story.edit')->middleware(['permission:cms-edit']);
        Route::post('/update', [CompanyStroyController::class, 'companyStoryUpdate'])->name('company.story.update')->middleware(['permission:cms-edit']);
        Route::get('/delete/{id}', [CompanyStroyController::class, 'companyStoryDelete'])->name('company.story.delete')->middleware(['permission:cms-delete']);
    });
    ...
    Route::group(['prefix' => 'testimonial'],function (){
        ...
        Route::post('/create', [TestimonilController::class, 'testimonialStore'])->name('testimonial.store')->middleware(['permission:cms-create']);
        Route::get('/edit/{id}', [TestimonilController::class, 'testimonialEdit'])->name('testimonial.edit')->middleware(['permission:cms-edit']);
        Route::post('/update', [TestimonilController::class, 'testimonialUpdate'])->name('testimonial.update')->middleware(['permission:cms-edit']);
        Route::get('/delete/{id}', [TestimonilController::class, 'testimonialDelete'])->name('testimonial.delete')->middleware(['permission:cms-delete']);
    });
    ...
    Route::group(['prefix' => 'coupon'],function (){
        ...
        Route::post('/create', [CouponController::class, 'couponStore'])->name('coupon.store')->middleware(['permission:coupon-create']);
        Route::get('/edit/{id}', [CouponController::class, 'couponEdit'])->name('coupon.edit')->middleware(['permission:coupon-edit']);
        Route::post('/update', [CouponController::class, 'couponUpdate'])->name('coupon.update')->middleware(['permission:coupon-edit']);
        Route::get('/delete/{id}', [CouponController::class, 'couponDelete'])->name('coupon.delete')->middleware(['permission:coupon-delete']);
    });
    ...
    Route::group(['prefix' => 'site-content/home-page'],function (){
        ...
        Route::post('/update', [HomePageController::class, 'homePageUpdate'])->name('home.page.site.content.update')->middleware(['permission:cms-edit']);
    });
    Route::group(['prefix' => 'site-content/about-page'],function (){
        ...
        Route::post('/update', [AboutUsPageController::class, 'aboutPageUpdate'])->name('about.page.site.content.update')->middleware(['permission:cms-edit']);
    });
    ...
    Route::group(['prefix' => 'social-link'],function (){
        ...
        Route::post('/update', [SocialLinkController::class, 'socialLinkUpdate'])->name('social.link.update')->middleware(['permission:cms-edit']);
    });
    ...
    Route::group(['prefix' => 'footer-information'],function (){
        ...
        Route::post('/update', [FooterInformationController::class, 'footerInformationUpdate'])->name('footer.information.update')->middleware(['permission:cms-edit']);
    });
    ...
    Route::post('/company/content-update/{id}', [CompanyController::class, 'contentUpdate'])->name('content_update')->middleware(['permission:cms-edit']);
    ...
    Route::post('/faq-update/{id}', [CustomerServiceController::class, 'faqUpdate'])->name('faq_update')->middleware(['permission:cms-edit']);
    Route::post('/faq-store', [CustomerServiceController::class, 'faqStore'])->name('faq_store')->middleware(['permission:cms-create']);
    Route::get('/faq-delete/{id}', [CustomerServiceController::class, 'faqDelete'])->name('faq_delete')->middleware(['permission:cms-delete']);
    ...
    Route::post('/order-status-change/{id}', [OrderController::class, 'orderStatusChange'])->name('order_status_change')->middleware(['permission:order-edit']);
    Route::get('/order-delete/{id}', [OrderController::class, 'orderDelete'])->name('order_delete')->middleware(['permission:order-delete']);
    ...
    Route::post('/order/digital-products-mail', [OrderController::class, 'digitalProductMail'])->name('digital_product_mail')->middleware(['permission:order-edit']);

    Route::get('/order-reports', [OrderReportController::class, 'orderReports'])->name('order-reports')->middleware(['permission:order-list|order-create|order-edit|order-delete']);
    ...
    Route::post('/page-store', [PageController::class, 'pageStore'])->name('page.store')->middleware(['permission:menu-create']);
    Route::get('/page-edit/{slug}', [PageController::class, 'pageEdit'])->name('page.edit')->middleware(['permission:menu-edit']);
    Route::post('/page-update/{id}', [PageController::class, 'pageUpdate'])->name('page.update')->middleware(['permission:menu-edit']);
    Route::get('/page-delete/{id}', [PageController::class, 'pageDelete'])->name('page.delete')->middleware(['permission:menu-delete']);
    ...
    Route::post('/store-menu', [MenuController::class, 'storeMenu'])->name('store_menu')->middleware(['permission:menu-create']);
    Route::get('/edit-menu/{id}', [MenuController::class, 'editMenu'])->name('edit_menu')->middleware(['permission:menu-edit']);
    Route::post('/update-menu/{id}', [MenuController::class, 'updateMenu'])->name('update_menu')->middleware(['permission:menu-edit']);
    Route::get('/delete-menu/{id}', [MenuController::class, 'deleteMenu'])->name('delete_menu')->middleware(['permission:menu-delete']);
    ...
    Route::post('/store-submenu', [MenuController::class, 'storeSubmenu'])->name('store_submenu')->middleware(['permission:menu-create']);
    Route::get('/edit-submenu/{id}', [MenuController::class, 'editSubmenu'])->name('edit_submenu')->middleware(['permission:menu-edit']);
    Route::post('/update-submenu/{id}', [MenuController::class, 'updateSubmenu'])->name('update_submenu')->middleware(['permission:menu-edit']);
    Route::get('/delete-submenu/{id}', [MenuController::class, 'deleteSubmenu'])->name('delete_submenu')->middleware(['permission:menu-delete']);
    ...
    Route::post('/store-currency', [CurrencyController::class, 'storeCurrency'])->name('store_currency')->middleware(['permission:currency-create']);
    Route::post('/update-currency/{id}', [CurrencyController::class, 'updateCurrency'])->name('update_currency')->middleware(['permission:currency-edit']);
    Route::get('/delete-currency/{id}', [CurrencyController::class, 'deleteCurrency'])->name('delete_currency')->middleware(['permission:currency-delete']);

    //Package
    Route::get('/package-list', [PackageController::class, 'packageList'])->name('package_list');
    Route::post('/package-package/{id}', [PackageController::class, 'updatePackage'])->name('update_package');
    ...
    Route::post('/language-update/{id}', [LanguageController::class, 'languageUpdate'])->name('language_update')->middleware(['permission:cms-edit']);
    ...
    Route::post('/country-tax-store', [EcommerceController::class, 'countryTaxStore'])->name('country_tax_store')->middleware(['permission:tax-create']);
    Route::post('/country-tax-update/{id}', [EcommerceController::class, 'countryTaxUpdate'])->name('country_tax_update')->middleware(['permission:tax-edit']);
    ...
    Route::post('/delivery-charge-store', [EcommerceController::class, 'countryDCStore'])->name('country_dc_store')->middleware(['permission:delivery-charge-create']);
    Route::post('/delivery-charge-update/{id}', [EcommerceController::class, 'countryDCUpdate'])->name('country_dc_update')->middleware(['permission:delivery-charge-edit']);

    //SEO Management
    Route::get('/manage-seo/{slug}', [SeoController::class, 'manageSeo'])->name('manage_seo')->middleware(['permission:cms-create|cms-edit']);
    Route::post('/update-seo/{slug}', [SeoController::class, 'updateSeo'])->name('update_seo')->middleware(['permission:cms-create|cms-edit']);
    ...
    Route::post('/store-admin', [UserController::class, 'storeAdmin'])->name('store_admin')->middleware(['permission:user-create']);
    Route::get('/edit-admin/{id}', [UserController::class, 'editAdmin'])->name('edit_admin')->middleware(['permission:user-edit']);
    Route::post('/update-admin/{id}', [UserController::class, 'updateAdmin'])->name('update_admin')->middleware(['permission:user-edit']);
    ...
    Route::get('/customer/{approve}/{user_id}', [UserController::class, 'customerApproveChange'])->name('customer_approve_change')->middleware(['permission:user-list|user-create|user-edit|user-delete']);
    Route::post('customer/change-package/{id}', [UserController::class, 'customerPackageChange'])->name('customer_package_change')->middleware(['permission:user-list|user-create|user-edit|user-delete']);
    Route::post('customer/send-email/{id}', [UserController::class, 'sendEmailToCustomer'])->name('send_email_to_customer')->middleware(['permission:user-list|user-create|user-edit|user-delete']);
    ...
    Route::post('/store-role', [RoleController::class, 'storeRole'])->name('store_role')->middleware(['role:Super Admin']);
    Route::get('/edit-role/{id}', [RoleController::class, 'editRole'])->name('edit_role')->middleware(['role:Super Admin']);
    Route::post('/update-role/{id}', [RoleController::class, 'updateRole'])->name('update_role')->middleware(['role:Super Admin']);
    Route::get('/delete-role/{id}', [RoleController::class, 'deleteRole'])->name('delete_role')->middleware(['role:Super Admin']);
    ...
    Route::post('/sitemap-store', [SitemapController::class, 'store'])->name('sitemap_store')->middleware(['role:Super Admin']);
    Route::get('/sitemap-delete', [SitemapController::class, 'delete'])->name('sitemap_delete')->middleware(['role:Super Admin']);
    Route::get('/sitemap-download/{id}', [SitemapController::class, 'download'])->name('sitemap_download')->middleware(['role:Super Admin']);
    ...
    Route::post('/payment-gateway-update/{slug}', [PaymentGatewayController::class, 'paymentGatewayUpdate'])->name('payment_gateway_update')->middleware(['permission:payment-gateway-edit']);
