...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Setting::create(['slug' => 'app_title', 'value' => 'Clean Power Store',]);
        ...
        Setting::create(['slug' => 'title', 'value' => 'Clean Power Store',]);
        ...
        Setting::create(['slug' => 'meta_description', 'value' => 'Clean Power Store',]);
