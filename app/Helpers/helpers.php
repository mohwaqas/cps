...
if(!function_exists('Category_all6'))
{
    function Category_all6()
    {
        return DB::select('SELECT c1.* FROM categories c1 LEFT JOIN categories c2 on c2.id = c1.parent_category ORDER BY COALESCE(c2.id, c1.id), c1.id limit 0,5');
        //return Category::all();
        //return Category::get();
    }
}

if(!function_exists('Category_all7'))
{
    function Category_all7()
    {
        return DB::select('SELECT c1.* FROM categories c1 LEFT JOIN categories c2 on c2.id = c1.parent_category ORDER BY COALESCE(c2.id, c1.id), c1.id limit 5,10');
        //return Category::all();
        //return Category::get();
    }
}
...
if(!function_exists('Category_Des_Icon'))
{
    ...
    {
        return Category::where('en_Description', '!=' ,null)->orWhere('Category_Icon','!=',null)->whereNull('parent_category')->get();
    }
}
...
if(!function_exists('Brnad6'))
{
    function Brnad6()
    {
        return Brand::where('Status',1)->limit(8)->get();
    }
}
if(!function_exists('Brnad7'))
{
    function Brnad7()
    {
        return Brand::where('Status',1)->skip(9)->take(8)->get(); 
    }
}
if(!function_exists('Brnad8'))
{
    function Brnad8()
    {
        return Brand::where('Status',1)->skip(7)->take(6)->get(); 
    }
}
...
if(!function_exists('userPackage')){
    function userPackage($user_id)
    {
