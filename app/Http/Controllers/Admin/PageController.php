...
class PageController extends Controller
{
    ...
    public function pageStore(PageStoreRequest $request)
    {
        ...
        if(!empty($store)) {
            return redirect()->route('admin.pages')->with('toast_success', __('Successfully stored'));
        }
    ...
    public function pageEdit($slug)
    {
        ...
        return redirect()->back()->with('toast_error', __('Page not found!'));
    }
    ...
    public function pageUpdate(Request $request, $id)
    {
        ...
        if(!is_null($page)) {
            ...
            if(!empty($update)) {
                return redirect()->back()->with('toast_success', __('Page successfully updated'));
            }
        }
        return redirect()->back()->with('toast_error', __('Something went wrong!'));
    }
    ...
    public function pageDelete($id)
    {
        ...
        if(!empty($page)) {
            return redirect()->back()->with('toast_success', __('Page successfully deleted!'));
        }
        return redirect()->back()->with('toast_error', __('Something went wrong!'));
    }
}
