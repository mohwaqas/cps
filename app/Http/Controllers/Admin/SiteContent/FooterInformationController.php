...
class FooterInformationController extends Controller
{
    ...
    public function footerInformationUpdate(Request $request){
        ...
        if ($update) {
            return redirect()->route('admin.footer.information.edit')->with('toast_success', __('Successfully Updated !'));
        }
        return redirect()->route('admin.footer.information.edit')->with('toast_success', __('Does not Updated !'));
    }
}
