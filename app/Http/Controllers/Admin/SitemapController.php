...
class SitemapController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.sitemap_list')->with('toast_success', __('Sitemap Generate Successfully'));
    }
    ...
    public function delete($id)
    {
        ...
        $sitemap->delete();
        return redirect()->back()->with('toast_success', __('Sitemap file deleted successfully!'));
    }
}
