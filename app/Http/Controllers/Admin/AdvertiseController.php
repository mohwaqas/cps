...
class AdvertiseController extends Controller
{
    ...
    public function advertiseStore(AdvertiseRequest $request){
        ...
        if ($slider) {
            return redirect()->route('admin.advertise')->with('toast_success', __('Successfully Stored !'));
        }
    ...
    public function advertiseUpdate(Request $request){
        ...
        if ($update) {
            return redirect()->route('admin.advertise')->with('toast_success', __('Successfully Update !'));
        }
    ...
    public function advertiseDelete($id){
        ...
        if ($delete) {
            $delete->delete();
            return redirect()->route('admin.advertise')->with('toast_success', __('Successfully Deleted !'));
        }
        return redirect()->route('admin.advertise')->with('toast_error', __('Does Not Delete!'));
    }
}
